...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('user/show/me', [UserController::class,'showMe']);
    ...
    Route::get('user/number', [UserController::class,'getNumberUser']);
    Route::post('user/change/status/{user}', [UserController::class,'changeStatusUser']);
